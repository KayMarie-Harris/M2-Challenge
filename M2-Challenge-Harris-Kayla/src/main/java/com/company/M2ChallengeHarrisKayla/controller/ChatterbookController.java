package com.company.M2ChallengeHarrisKayla.controller;

import com.company.M2ChallengeHarrisKayla.ChatterPost;
import com.company.M2ChallengeHarrisKayla.User;
...
public class ChatterbookController
{
    ...
    // Returns all Users and their chatterposts in an array
    ...
    // Returns one user and their chatterposts from their name
    ...
    // Returns a users chatterposts from their name
    @GetMapping(value= "/users/chatterposts/{name}")
    public List<ChatterPost> usersChatterPosts(@PathVariable String name)
    {
        User selectedUser = null;
        for(User user : userList)
        {
